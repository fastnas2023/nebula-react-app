                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-white/5">
                                <tr className="hover:bg-white/5 transition-colors group cursor-pointer" onClick={() => navigate('/recording')}>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-lg bg-nebula-cyan/20 text-nebula-cyan flex items-center justify-center flex-shrink-0">
                                                <Play className="w-3.5 h-3.5 ml-0.5" />
                                            </div>
                                            <div>
                                                <div className="font-bold text-white text-sm">Design System Sync</div>
                                    ...
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Calendar className="w-3.5 h-3.5 text-white/30" /> Oct 21, 2026
                                        </div>
                                    </td>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Clock className="w-3.5 h-3.5 text-white/30" /> 1 hr 15 mins
                                        </div>
                                    </td>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Users className="w-3.5 h-3.5 text-white/30" /> 4
                                        </div>
                                    </td>
                                    <td className="px-6 py-3 text-right">
                                        <button className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 font-bold text-xs transition-colors shadow-lg shadow-emerald-500/10 opacity-0 group-hover:opacity-100 focus:opacity-100">
                                ...
                                <tr className="hover:bg-white/5 transition-colors group cursor-pointer" onClick={() => navigate('/recording')}>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-lg bg-nebula-purple/20 text-nebula-purple flex items-center justify-center flex-shrink-0">
                                                <Play className="w-3.5 h-3.5 ml-0.5" />
                                            </div>
                                            <div>
                                    ...
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Calendar className="w-3.5 h-3.5 text-white/30" /> Oct 23, 2026
                                        </div>
                                    </td>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Clock className="w-3.5 h-3.5 text-white/30" /> 45 mins
                                        </div>
                                    </td>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Users className="w-3.5 h-3.5 text-white/30" /> 12
                                        </div>
                                    </td>
                                    <td className="px-6 py-3 text-right">
                                        <button className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 font-bold text-xs transition-colors shadow-lg shadow-emerald-500/10 opacity-0 group-hover:opacity-100 focus:opacity-100">
                                ...
                                <tr className="hover:bg-white/5 transition-colors group cursor-pointer" onClick={() => navigate('/recording')}>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-lg bg-white/10 text-white/70 flex items-center justify-center flex-shrink-0">
                                                <Play className="w-3.5 h-3.5 ml-0.5" />
                                            </div>
                                            <div>
                                                <div className="font-bold text-white text-sm">Engineering All-Hands</div>
                                                <div className="text-[11px] text-white/40 mt-0.5">ID: ENG-4421-M</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Calendar className="w-3.5 h-3.5 text-white/30" /> Oct 18, 2026
                                        </div>
                                    </td>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Clock className="w-3.5 h-3.5 text-white/30" /> 58 mins
                                        </div>
                                    </td>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-2 text-xs text-white/70">
                                            <Users className="w-3.5 h-3.5 text-white/30" /> 45
                                        </div>
                                    </td>
                                    <td className="px-6 py-3 text-right">
                                        <button className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-emerald-500/10 text-emerald-400 hover:bg-emerald-500/20 font-bold text-xs transition-colors shadow-lg shadow-emerald-500/10 opacity-0 group-hover:opacity-100 focus:opacity-100">
