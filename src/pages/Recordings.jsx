                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-white/5">
                                ...
                                <tr className="hover:bg-white/5 transition-colors group cursor-pointer" onClick={() => navigate('/recording')}>
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-xl bg-white/5 text-white/70 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:bg-white/10 transition-all">
                                                <Play className="w-4 h-4 ml-0.5" />
                                            </div>
                                            <div>
                                                <div className="font-display font-bold text-white text-base group-hover:text-white/90 transition-colors">Engineering All-Hands</div>
                                                <div className="text-xs text-white/40 mt-1 font-mono">ID: ENG-4421-M</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
